const tempMessage = (pgn, temp, inst, src) => {
  return {
    pgn,
    prio: 2,
    dst: 255,
    fields: {
      instance: inst,
      source: src,
      [pgn === 130316 ? "temperature" : "actualTemperature"]: temp,
    },
  };
};
              ...
              expected: [
                (testOptions) => {
                  const expectedInstance =
                    testOptions[optionKey].instance !== undefined
                      ? testOptions[optionKey].instance
                      : info.instance;
